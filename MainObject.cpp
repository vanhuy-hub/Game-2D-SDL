...
void MainObject::CenterEntityOnMap(Map &map_data) {
    ...
    map_data.start_x_ = x_pos_ - halfScreenWidth;
    ...
    map_data.start_y_ = y_pos_ - halfScreenHeight;
 ...
 if (x1 >= 0 && x2 < MAX_MAP_X && y1 >= 0 && y2 < MAX_MAP_Y)
  {
      if (x_val_ > 0) // when object is moving by right  ===>
      {
        ...
        //std::cout << "map_data.tile[y1][x2]: " << map_data.tile[y1][x2] << ", map_data.tile[y2][x2]: " << map_data.tile[y2][x2] << std::endl;
